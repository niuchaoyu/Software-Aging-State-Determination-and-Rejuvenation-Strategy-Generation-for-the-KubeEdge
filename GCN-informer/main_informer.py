...
parser.add_argument('--data', type=str, required=False, default='MYDATA', help='data')
parser.add_argument('--root_path', type=str, default='./data/ETT/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='2024-05-5_train_constant.csv', help='data file')
...
data_parser = {
    ...
    'MYDATA':{'data':'2024-05-5_train_constant.csv','T':'response_time','M':[3,3,3],'S':[1,1,1],'MS':[3,3,1]},
}
